...
import org.mule.modules.exchange.pooling.DevkitGenericKeyedObjectPool;


/**
 * A {@code ExchangeConnectorConnectionManager} is a wrapper around {@link ExchangeConnector } that adds connection management capabilities to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.2", date = "2015-02-04T07:14:23+05:30", comments = "Build UNNAMED.2039.0541b23")
public class ExchangeConnectorConnectionManager
    extends ExpressionEvaluatorSupport
    implements MetadataAware, MuleContextAware, ProcessAdapter<ExchangeConnectorRestClientAdapter> , Capabilities, Disposable, Initialisable, Testable, ConnectionManager<ExchangeConnectorConnectionKey, ExchangeConnectorRestClientAdapter>
{
    ...
    public void initialise() {
        connectionPool = new DevkitGenericKeyedObjectPool(new ExchangeConnectorConnectionFactory(this), poolingProfile);
    ...
    public ExchangeConnectorRestClientAdapter acquireConnection(ExchangeConnectorConnectionKey key)
        throws Exception
    {
        return ((ExchangeConnectorRestClientAdapter) connectionPool.borrowObject(key));
    }

    public void releaseConnection(ExchangeConnectorConnectionKey key, ExchangeConnectorRestClientAdapter connection)
        throws Exception
    {
        connectionPool.returnObject(key, connection);
    }

    public void destroyConnection(ExchangeConnectorConnectionKey key, ExchangeConnectorRestClientAdapter connection)
        throws Exception
    {
    ...
    @Override
    public<P >ProcessTemplate<P, ExchangeConnectorRestClientAdapter> getProcessTemplate() {
        return new ExchangeConnectorManagedConnectionProcessTemplate(this, muleContext);
    }

    @Override
    public ExchangeConnectorConnectionKey getDefaultConnectionKey() {
        return new ExchangeConnectorConnectionKey(getUsername(), getPassword());
    }

    @Override
    public ExchangeConnectorConnectionKey getEvaluatedConnectionKey(MuleEvent event)
        throws Exception
    {
        if (event!= null) {
            ...
            return new ExchangeConnectorConnectionKey(_transformedUsername, _transformedPassword);
        }
    ...
    public TestResult test() {
        ExchangeConnectorRestClientAdapter connection = null;
        DefaultTestResult result;
        ExchangeConnectorConnectionKey key = getDefaultConnectionKey();
        try {
